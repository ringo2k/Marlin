...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION (X_MAX_POS - 50)
    ...
    // is used to esimate the plane of the print bed
      ...
      #define ABL_PROBE_PT_1_Y (Y_MAX_POS -20) //180
      #define ABL_PROBE_PT_2_X 15
      #define ABL_PROBE_PT_2_Y 20
      #define ABL_PROBE_PT_3_X (X_MAX_POS-65)
...
#define HOMING_FEEDRATE {22*60, 22*60, 60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,2560.0,551.1889}  // default steps per unit for Ultimaker
...
// on RAMPS1 SERVO1 Signal = blue, SERV02=red
